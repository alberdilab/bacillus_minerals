...
To add the missing information the BSGatlas GFF file for B.subtilis str 168 was downloaded from [BSGatlas](https://rth.dk/resources/bsgatlas/download.php)

```{r prepare_bsg_annotation, warning=FALSE, comments="", message=FALSE, eval=FALSE}
...
```{r load_bsg_gff, warning=FALSE, comments="", message=FALSE}
...
```{r consistency_evalutaion, warning=FALSE, comments="", message=FALSE, eval=FALSE}
